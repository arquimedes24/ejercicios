        ...
        ncartones.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0)
            {
                try
                {
                    ...
                    int nc;
                    for(nc = Integer.parseInt(JOptionPane.showInputDialog("Digite el numero de Jugadores:")); nc > 5 || nc < 1; nc = Integer.parseInt(JOptionPane.showInputDialog("Digite el numero de Jugadores:")));
                    swsihaycarton = true;
                ...
                {
                    JOptionPane.showMessageDialog(null, "Error, digite un numero valido, maximo 3.");
                }
            }
        }
);
